...
```bash
uv tool install specify-cli --from git+https://github.com/cr24osome/spec-kit.git
```
...
```bash
uv tool install specify-cli --force --from git+https://github.com/cr24osome/spec-kit.git
```
...
```bash
uvx --from git+https://github.com/cr24osome/spec-kit.git specify init <PROJECT_NAME>
```
